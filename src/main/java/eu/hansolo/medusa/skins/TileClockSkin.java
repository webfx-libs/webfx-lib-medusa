...
public class TileClockSkin extends ClockSkinBase {
    ...
    private void drawTicks() {
        ...
        Point2D center                 = new Point2D(0 * clockSize * 0.5, 0 * clockSize * 0.5);
    ...
    private void resizeText() {
        ...
        title.setFont(Font.font(fontSize) /*Fonts.latoRegular(fontSize)*/);
        ...
        maxWidth = size * 0.6;
        dateText.setFont(Font.font(fontSize) /*Fonts.latoRegular(fontSize)*/);
    ...
    protected void resize() {
        ...
        if (size > 0) {
            ...
            drawTicks();
            hourTickMarks.relocate((size - clockSize * 0.465 * 2 /*hourTickMarks.getLayoutBounds().getWidth()*/) * 0.5,
                                   (size - clockSize * 0.465 * 2 /*hourTickMarks.getLayoutBounds().getHeight()*/) * 0.5);
            minuteTickMarks.relocate((size - clockSize * 0.465 * 2 /*minuteTickMarks.getLayoutBounds().getWidth()*/) * 0.5,
                                   (size - clockSize * 0.465 * 2 /*minuteTickMarks.getLayoutBounds().getHeight()*/) * 0.5);
