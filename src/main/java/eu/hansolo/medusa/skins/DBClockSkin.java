...
public class DBClockSkin extends ClockSkinBase {
    ...
    @Override protected void resize() {
        ...
        double secondWidth  = size * 0.11866667; // was second.getLayoutBounds().getWidth() but emulated getLayoutBounds() not yet working
        double secondHeight = size * 0.46266667; // was second.getLayoutBounds().getHeight() but emulated getLayoutBounds() not yet working
        ...
        if (size > 0) {
            ...
            createSecondPointer();
            second.setFill(clock.getSecondColor());
            second.relocate((size -  secondWidth) * 0.5, center - secondHeight);
            ...
            title.setFont(Font.font(size * 0.12) /*Fonts.latoLight(size * 0.12)*/);
            ...
            secondRotate.setPivotX(secondWidth * 0.5);
            secondRotate.setPivotY(secondHeight);
        }
    }
