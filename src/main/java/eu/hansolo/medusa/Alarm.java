...
public class Alarm {
    ...
    public static class AlarmMarkerEvent extends Event {;
        public static final EventType<AlarmMarkerEvent> ALARM_MARKER_PRESSED  = new EventType(ANY, "ALARM_MARKER_PRESSED" + Uuid.randomUuid() /*UUID.randomUUID().toString()*/);
        public static final EventType<AlarmMarkerEvent> ALARM_MARKER_RELEASED = new EventType(ANY, "ALARM_MARKER_RELEASED" + Uuid.randomUuid() /*UUID.randomUUID().toString()*/);
