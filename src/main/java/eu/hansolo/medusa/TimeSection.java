...
public class TimeSection implements Comparable<TimeSection> {
    ...
    public static class TimeSectionEvent extends Event {
        public static final EventType<TimeSectionEvent> TIME_SECTION_ENTERED = new EventType(ANY, "TIME_SECTION_ENTERED" + Uuid.randomUuid() /*UUID.randomUUID().toString()*/);
        public static final EventType<TimeSectionEvent> TIME_SECTION_LEFT    = new EventType(ANY, "TIME_SECTION_LEFT" + Uuid.randomUuid() /*UUID.randomUUID().toString()*/);
